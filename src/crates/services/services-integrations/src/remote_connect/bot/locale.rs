...
pub struct BotStrings {
    ...
    pub resume_untitled: &'static str,
...
请在 Api4Ward 桌面端打开 Remote Connect 面板，复制 6 位配对码并发送到这里完成连接。",
    paired_success: "配对成功，Api4Ward 已连接。",
    need_pairing: "尚未连接 Api4Ward 桌面端。请先发送 6 位配对码。",
    ...
    main_title_assistant: "Api4Ward · 助理模式",
    main_title_expert: "Api4Ward · 专业模式",
    settings_title: "设置",
    welcome_title: "Api4Ward",
    ...
    footer_reply_session_or_next: "回复会话编号；发送 0 查看下一页，或发送 /menu 返回",
    ...
    switch_no_workspaces: "尚未发现工作区，请先在 Api4Ward 桌面端打开一个项目。",
    switch_no_assistants: "尚未发现助理，请先在 Api4Ward 桌面端创建一个助理。",
    current_marker: " · 当前",

    resume_no_sessions: "当前还没有会话，可以发送 /new 直接新建。",
    resume_page_label: "会话历史",
    resume_untitled: "未命名会话",
    ...
    switch_model_no_models: "没有可用的模型，请先在 Api4Ward 桌面端配置 AI 模型。",
    ...
    session_system_unavailable: "Api4Ward 会话系统尚未就绪，请稍后再试。",
    ...
    devices_title: "多设备控制",
    devices_account_required: "所连接的桌面端尚未登录 Api4Ward 账号，无法使用多设备控制。请在桌面端的账号登录对话框中登录，机器人会自动继承账号身份。",
    ...
    devices_local: "本地设备",
    devices_pick_to_switch: "回复序号切换设备，之后所有操作在该设备上执行；发送 0 返回",
...
請在 Api4Ward 桌面端打開 Remote Connect 面板，複製 6 位配對碼併發送到這裡完成連接。",
    paired_success: "配對成功，Api4Ward 已連接。",
    need_pairing: "尚未連接 Api4Ward 桌面端。請先發送 6 位配對碼。",
    ...
    main_title_assistant: "Api4Ward · 助理模式",
    main_title_expert: "Api4Ward · 專業模式",
    settings_title: "設置",
    welcome_title: "Api4Ward",
    ...
    footer_reply_session_or_next: "回覆會話編號；發送 0 查看下一頁，或發送 /menu 返回",
    ...
    switch_no_workspaces: "尚未發現工作區，請先在 Api4Ward 桌面端打開一個項目。",
    switch_no_assistants: "尚未發現助理，請先在 Api4Ward 桌面端創建一個助理。",
    current_marker: " · 當前",

    resume_no_sessions: "當前還沒有會話，可以發送 /new 直接新建。",
    resume_page_label: "會話歷史",
    resume_untitled: "未命名會話",
    ...
    switch_model_no_models: "沒有可用的模型，請先在 Api4Ward 桌面端配置 AI 模型。",
    ...
    session_system_unavailable: "Api4Ward 會話系統尚未就緒，請稍後再試。",
    ...
    devices_title: "多裝置控制",
    devices_account_required: "所連接的桌面端尚未登入 Api4Ward 帳號，無法使用多裝置控制。請在桌面端的帳號登入對話框中登入，機器人會自動繼承帳號身份。",
    ...
    devices_local: "本地裝置",
    devices_pick_to_switch: "回覆序號切換裝置，之後所有操作在該裝置上執行；發送 0 返回",
...
Open Remote Connect in Api4Ward Desktop and send the 6-digit pairing code here to connect.",
    paired_success: "Pairing successful. Api4Ward is now connected.",
    need_pairing: "Not connected yet. Please send the 6-digit pairing code first.",
    invalid_pairing_code: "Invalid or expired pairing code. Generate a new one in Api4Ward Desktop and try again.",
    ...
    main_title_assistant: "Api4Ward · Assistant",
    main_title_expert: "Api4Ward · Expert",
    ...
    footer_reply_session_or_next:
        "Reply with a session number; send 0 for the next page, or /menu to return.",
    ...
    switch_no_workspaces: "No workspaces found. Open a project in Api4Ward Desktop first.",
    switch_no_assistants: "No assistants found. Create one in Api4Ward Desktop first.",
    current_marker: " · current",

    resume_no_sessions: "No sessions yet. Send /new to create one.",
    resume_page_label: "Sessions",
    resume_untitled: "Untitled session",
    ...
    switch_model_no_models: "No models available. Please configure AI models in Api4Ward Desktop first.",
    ...
    session_system_unavailable: "Api4Ward session system is not ready yet.",
    ...
    auto_push_skip_too_large_fmt: "Skipping \"{name}\": {size} exceeds the {limit} limit. Please grab it from Api4Ward Desktop instead.",
    auto_push_failed_fmt: "Failed to send \"{name}\": {err}",

    devices_title: "Multi-device Control",
    devices_account_required: "The paired desktop is not logged into a Api4Ward account, so multi-device control is unavailable. Log in via the desktop's Account Login dialog and the bot will inherit the account identity.",
    ...
    devices_pick_to_switch:
        "Reply with a number to switch — all subsequent commands run on that device; send 0 to return",
